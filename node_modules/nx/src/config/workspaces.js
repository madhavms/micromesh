...
function getGlobPatternsFromPackageManagerWorkspaces(root) {
    ...
    try {
        try {
            ...
            const res = normalizePatterns(Array.isArray(workspaces) ? workspaces : (_a = workspaces === null || workspaces === void 0 ? void 0 : workspaces.packages) !== null && _a !== void 0 ? _a : []);
            if (res.length > 0)
                return res;
...
function deduplicateProjectFiles(files, ig) {
    ...
    files.forEach((file) => {
        ...
        if (file === 'package.json')
            return; // file is workspace root package json

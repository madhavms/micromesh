 ...
 */
export declare function transitiveDependencyPnpmLookup(packageName: string, parentPackage: string, versions: PackageVersions, version: string): PackageDependency;
/**
 ...
 * @returns
 */
export declare function prunePnpmLockFile(lockFileData: LockFileData, packages: string[]): LockFileData;
